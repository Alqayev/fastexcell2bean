package large.excell.to.bean.ta.utilities.factory;
...
import large.excell.to.bean.ta.utilities.StreamingReader;
import large.excell.to.bean.ta.utilities.annotations.ExcelBean;
import large.excell.to.bean.ta.utilities.annotations.ExcelColumnHeader;
import large.excell.to.bean.ta.utilities.annotations.ExcelColumnIndex;
import large.excell.to.bean.ta.utilities.bean.ResponseBean;
import large.excell.to.bean.ta.utilities.enums.CoreMessages;
...
public class  Parser<T extends ResponseBean> {
	 ...
	 */
	public List<T> parse(String filePath) throws InvalidFormatException, IOException, InstantiationException,
				...
				for (Row row : sheet) {
					if (Objects.nonNull(row)) {
						if (isEquals(excelFactoryType , ExcelFactoryType.COLUMN_INDEX_BASED_EXTRACTION)) 
							if (isEquals(row.getRowNum() , 0) && skipHeader) continue;
	 ...
	 * @throws InstantiationException
	 */
	public List<T> parse(byte [] file) throws InvalidFormatException, IOException, InstantiationException,
	IllegalAccessException, IllegalArgumentException, ParseException {
	 ...
	 * @throws IllegalArgumentException
	 */
	public T getBeanForARow(Row row)
	 ...
	 * @throws ParseException
	 */
	private void setCellValueBasedOnDesiredExcelFactoryType(T classObj, String columnValue, int columnIndex)
